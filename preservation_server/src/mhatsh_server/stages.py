...
PREFIXED_NUMERIC_DRAMA_STAGE_SCRIPT_GROUPS: dict[int, tuple[str, ...]] = {
    102301: ("xht_102301_1",),
    103301: ("xht_103301_1",),
    202101: ("tc_202101_1",),
    202301: ("xht_202301_1",),
    ...
    401003: ("fzx_401003_01",),
    402103: ("fzx_402103_01",),
    402301: ("xht_402301_1",),
    502301: ("xht_502301_1",),
    503301: ("xht_503301_1",),
    601004: ("fzx_601004_01",),
    602301: ("xht_602301_1",),
    603103: ("fzx_603103_01",),
    603301: ("xht_603301_1",),
    801203: ("tc_801203_1", "tc_801203_2", "tc_801203_3"),
    802301: ("xht_802301_1",),
    803301: ("xht_803301_1",),
    902301: ("xht_902301_1",),
    903301: ("xht_903301_1",),
    1001101: ("tc_1001101_1",),
}
...
STAGE_CFG_SCRIPT_ROUTE_GROUPS: dict[int, tuple[str, ...]] = {
    ...
    200056: ("area3_2_1", "area3_2_2"),
    200107: ("210",),
    200125: ("143",),
    201005: ("act_signal",),
    201006: ("chase_end",),
    211066: ("area1_1_1start",),
    211166: ("area1_1_1end",),
    211266: ("area1_2_2boss", "area1_2_2end"),
    211366: ("area1_3_2boss", "area1_3_2end"),
    212201: ("act01",),
    220210: ("zx_201103_1",),
    300025: ("tx1_1_2", "tx1_1_4end"),
    300104: ("zx0_1_2",),
    300105: ("shiliguan04",),
    300301: ("zx_touqiu",),
    300401: ("zx_usj_002",),
    300405: ("300406", "zx_usj_005"),
    300502: ("zx_tyj03",),
    300505: ("zx_tyj05",),
    300506: ("zx_tyj06",),
    310401: ("usj_bh1",),
    310403: ("zx_usj_03002",),
    310405: ("zx_usj_003", "zx_usj_004"),
    ...
    406506: ("stage406506",),
    412101: ("nightarea",),
    412161: ("night2-1-3BOSS",),
    412164: ("nightarea-speciel",),
    412261: ("night2-2-3BOSS",),
    412361: ("night2-3-3BOSS",),
    412461: ("night2-4-3BOSS",),
    413261: ("kn3_2_4",),
    413461: ("kn3_4_4boss",),
    415561: ("kn5_5_6",),
    500047: ("255",),
...
def _prefixed_numeric_drama_stage_definitions() -> tuple[BattleStageDefinition, ...]:
    occupied_ids = (
        EXPLICIT_RECOVERED_STAGE_IDS
        | set(ZX_NUMERIC_STAGE_SCRIPT_GROUPS)
        | set(ASSET_NUMERIC_DRAMA_STAGE_SCRIPT_GROUPS)
        | set(INDEX_NUMERIC_DRAMA_STAGE_SCRIPT_GROUPS)
        | set(STAGE_CFG_SCRIPT_ROUTE_GROUPS)
    )
    return tuple(
        BattleStageDefinition(
            key=f"prefixed_numeric_drama_stage_{stage_id}",
            label=f"prefixed numeric drama stage {stage_id}",
            stage_id=stage_id,
            scripts=scripts,
            source=(
                "parsed from prefixed drama script names in "
                "analysis/intro_qte_asset_index.txt, 2026-06-24"
            ),
        )
        for stage_id, scripts in sorted(
            PREFIXED_NUMERIC_DRAMA_STAGE_SCRIPT_GROUPS.items()
        )
        if stage_id not in occupied_ids
    )
...
RECOVERED_BATTLE_STAGES = (
    ...
    *_prefixed_numeric_drama_stage_definitions(),
    ...
    *_drama_family_stage_definitions(),
    ...
    BattleStageDefinition(
        ...
        audio_events=(
            ...
            "PLOT_copyright_zx_ruxue03_2_1_01",
            "PLOT_copyright_zx_ruxue03_2_1_02",
            "PLOT_copyright_zx_ruxue03_2_1_03",
            "PLOT_copyright_zx_ruxue03_2_1_04",
            "PLOT_copyright_zx_ruxue03_2_1_05",
            "PLOT_copyright_zx_ruxue03_2_1_06",
            "PLOT_zx_ruxue02_03",
            "PLOT_zx_ruxue02_04",
            "PLOT_zx_ruxue02_05",
            "PLOT_zx_ruxue03_1_01",
            "PLOT_zx_ruxue03_1_02",
            "PLOT_zx_ruxue03_1_03",
            "PLOT_zx_ruxue03_2_02",
            "PLOT_zx_ruxue03_2_03",
            "PLOT_zx_ruxue03_2_04",
            "PLOT_zx_ruxue03_2_05",
            "PLOT_zx_ruxue03_2_06",
            "PLOT_zx_ruxue03_2_07",
            "PLOT_zx_ruxue03_2_08",
